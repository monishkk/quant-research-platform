...
Regenerates every figure, table, and CSV in `reports/momentum/`. The configuration file is the complete description of the run. 183 tests (`python -m pytest`) cover the engine accounting, every metric against an analytically known answer, look-ahead perturbation tests, and end-to-end determinism.
